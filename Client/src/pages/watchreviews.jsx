...
export function WatchReviews() {
    ...
    const handleAccept = (index) => {
        ...
        axios.delete('https://lifestylebulider-api.onrender.com/api/programs/delete-program', {
            data: {
    ...
    const fetchData = async () => {
        ...
        axios.get('https://lifestylebulider-api.onrender.com/api/programs/all-programs', {
            params: {
