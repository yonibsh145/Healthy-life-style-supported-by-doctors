...
export function SignIn() {
  ...
  function handleLogin(event) {
    ...
    if (selectedValue == "User") {
      axios.post('https://life-style-builder-api.onrender.com/api/users/login', userData)
        .then(response => {
          // Handle success.
    ...
    if (selectedValue == "Specialist") {
      axios.post('https://life-style-builder-api.onrender.com/api/specialists/login', userData)
        .then(response => {
          // Handle success.
          const userProfile = response.data;
          console.log('User profile', userProfile);
