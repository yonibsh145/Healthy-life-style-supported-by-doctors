...
export function WaitingList() {
    ...
    const handleAccept = (index) => {
        ...
        axios.put('https://lifestylebulider-api.onrender.com/api/specialists/updaterequest', requestData)
            .then(response => {
                // Handle success.
    ...
    const fetchData = async () => {
        ...
        axios.get('https://lifestylebulider-api.onrender.com/api/specialists/requests', {
            params: {
                specialistId: userProfile._id
            }
        })
