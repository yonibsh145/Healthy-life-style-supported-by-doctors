...
export function SignUp() {
  ...
  function handleSubmit(event) {
    ...
    if (selectedValue == "User") {
      axios.post('https://life-style-builder-api.onrender.com/api/users/register', userData)
        .then(response => {
          // Handle success.
    ...
    if (selectedValue == "Specialist") {
      axios.post('https://life-style-builder-api.onrender.com/api/specialists/register', userData)
        .then(response => {
          // Handle success.
          console.log('User profile', response.data.user);
          console.log('User token', response.data.token);
